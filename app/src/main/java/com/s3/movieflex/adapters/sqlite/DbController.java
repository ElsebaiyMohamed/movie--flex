...
public class DbController {
    ...
    public long addMovie(Movie movie) {
        ...
        values.put(DbHelper.TAB1_COLO6, movie.getStudio());
    ...
    public ArrayList<Movie> selectAllMovie() {
        ...
        while (!cursor.isAfterLast()) {
            ...
            movies.add(new Movie(cursor.getInt(0), cursor.getString(1), cursor.getString(2), cursor.getInt(3), cursor.getInt(4), cursor.getString(5), cursor.getFloat(6), cursor.getString(7), c1));
            cursor.moveToNext();
        }
    ...
    private ArrayList<Cast> selectCast(long id) {
        ...
        cursor.moveToFirst();
        while (!cursor.isAfterLast()) {
            cast.add(new Cast(cursor.getString(1), cursor.getInt(2)));
            cursor.moveToNext();
        }
